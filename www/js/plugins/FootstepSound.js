...
(function () {
    ...
    var footStepJson = {
        ...
        always: {
            interval: 2,
            walk1: { name: 'ft_dirt1', volume: 30, pitch: 80, pan: 30 },
            walk2: { name: 'ft_dirt1', volume: 35, pitch: 90, pan: 40 },
            dash1: { name: 'ft_dirt2', volume: 40, pitch: 90, pan: 35 },
            dash2: { name: 'ft_dirt2', volume: 45, pitch: 100, pan: 45 },
        },
        // 梯子属性通過時の足音
        ladder: {
            interval: 1,
        ...
        terrainTag1: {
            interval: 1,
            walk1: { name: '', volume: 90, pitch: 100, pan: -30 },
            walk2: { name: '', volume: 90, pitch: 100, pan: -20 },
            dash1: { name: '', volume: 90, pitch: 100, pan: -15 },
            dash2: { name: '', volume: 90, pitch: 100, pan: -10 },
        },
        // リージョン 1 通過時の足音（2以降はコピーするか以下の通り値を変更してください）
        // region1 → region2
        region6: {
            interval: 1,
            walk1: { name: 'ft_water1', volume: 70, pitch: 80, pan: -20 },
            walk2: { name: 'ft_water2', volume: 80, pitch: 90, pan: -25 },
            dash1: { name: 'ft_water1', volume: 75, pitch: 95, pan: -25 },
            dash2: { name: 'ft_water2', volume: 85, pitch: 100, pan: -30 },
        },
        region24: {
            interval: 2,
            walk1: { name: 'ft_grass1', volume: 40, pitch: 70, pan: -20 },
            walk2: { name: 'ft_grass1', volume: 45, pitch: 75, pan: -25 },
            dash1: { name: 'ft_grass1', volume: 50, pitch: 80, pan: -25 },
            dash2: { name: 'ft_grass1', volume: 60, pitch: 90, pan: -35 },
        },
        region27: {
            interval: 2,
            walk1: { name: 'ft_dirt2', volume: 50, pitch: 40, pan: -20 },
            walk2: { name: 'ft_dirt2', volume: 55, pitch: 45, pan: -25 },
            dash1: { name: 'ft_dirt2', volume: 55, pitch: 50, pan: -25 },
            dash2: { name: 'ft_dirt2', volume: 60, pitch: 55, pan: -35 },
        },
        region5: {
            interval: 2,
            walk1: { name: 'ft_yama', volume: 50, pitch: 40, pan: -20 },
            walk2: { name: 'ft_yama', volume: 55, pitch: 45, pan: -25 },
            dash1: { name: 'ft_yama', volume: 55, pitch: 50, pan: -25 },
            dash2: { name: 'ft_yama', volume: 60, pitch: 55, pan: -35 },
        },
        region23: {
            interval: 2,
            walk1: { name: 'ft_snow1', volume: 50, pitch: 80, pan: -20 },
            walk2: { name: 'ft_snow1', volume: 55, pitch: 85, pan: -25 },
            dash1: { name: 'ft_snow2', volume: 55, pitch: 90, pan: -25 },
            dash2: { name: 'ft_snow2', volume: 60, pitch: 95, pan: -35 },
        },
    };
    //=============================================================================
    // ユーザ書き換え領域 - 終了 -
