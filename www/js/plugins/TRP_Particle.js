...
(function () {
	...
	***************************************************************************** */
	...
	Scene_Map.prototype.createParticleSystem = function () {
		/* modified following 1 line by nekoma. 2021/12/10 */
		// if(ParticleSystem.temporallyCacheForSceneMap && ParticleSystem.cacheMapId===$gameMap.mapId()){
		if (ParticleSystem.temporallyCacheForSceneMap && ParticleSystem.cacheMapId === $gameMap.mapId() && ($gamePlayer.newMapId() == 0 || $gamePlayer.newMapId() == $gameMap.mapId())) {
