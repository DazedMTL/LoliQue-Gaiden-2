...
//=============================================================================
/*:ja
* @plugindesc v1.04 リージョンを用いて、イベントおよびプレイヤーの移動制限を行います。
...
*   特定のマップ上のすべてのイベントに対してリージョンxを制限します。
*   より多くのリージョンを設定するには複数のxを使用してください。
*   xからyまで、多数のリージョンを設定することができます。
*
...
*   プレーヤーと特定のマップ上のすべてのイベントに対してリージョンxを制限します。
*   より多くのリージョンを設定するには複数のxを使用してください。
*   xからyまで、多数のリージョンを設定することができます。
*
...
*   特定のマップ上のすべてのイベントに対してリージョンxを許可します。
*   より多くのリージョンを設定するには複数のxを使用してください。
*   xからyまで、多数のリージョンを設定することができます。
*
*   <All Allow Region: x>
...
*   特定のマップ上のプレーヤーとすべてのイベントにリージョンxを許可します。
*   より多くのリージョンを設定するには複数のxを使用してください。
